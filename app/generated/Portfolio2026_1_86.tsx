...
export default function Web1440Px({ heroEffectReady = true }: Web1440PxProps) {
  return (
    <div className="bg-[#f7f7f7] content-stretch flex flex-col gap-[150px] min-[768px]:max-lg:gap-[44px] max-md:gap-[36px] items-center px-0 pt-[24px] pb-[24px] max-[1023px]:px-[24px] max-lg:pt-[24px] max-lg:pb-[clamp(16px,2.5vw,24px)] max-md:pt-[24px] max-md:pb-[24px] relative size-full" data-name="web-1440px" data-node-id="1:86">
      <BadgeHeader />
