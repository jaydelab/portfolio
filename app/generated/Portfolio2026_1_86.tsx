...
const imgCapturaDeTela20260317As0335361 = "/visual-ir-assets/1fc9faf14b240e6d27d4efc90e18c98000159180.png";
...
const imgBackground = "/visual-ir-assets/b9b0f2ddb3b952e826042cb334932374c19e296b.png";
...
const imgPreview11 = "/visual-ir-assets/cta-preview-right.png";
...
export default function Web1440Px() {
  return (
    <div className="bg-[#f7f7f7] content-stretch flex flex-col gap-[150px] items-center p-[24px] relative size-full" data-name="web-1440px" data-node-id="1:86">
      <div className="backdrop-blur-[25px] bg-[rgba(0,0,0,0.55)] content-stretch flex flex-col h-[34px] items-center justify-center px-[20px] rounded-[18px] shrink-0 sticky top-[24px] z-50" data-name="Badge" data-node-id="1:1338">
            ...
            <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container" data-node-id="1:91">
              <div className="figma-font-halant-ptbr flex flex-col justify-center min-w-full not-italic relative shrink-0 text-[#393737] text-[0px] text-center tracking-[-3.5px] w-[min-content]" data-node-id="1:92">
                <p className="text-[70px]">
                  <span className="figma-font-georgia not-italic tracking-[-3.5px] leading-[90px]">Claude e Codex são</span>
                  <span className="leading-[90px]">{` `}</span>
                  <span className="figma-font-halant-ptbr not-italic text-[#888787] tracking-[-3.5px] leading-[90px]">funcionários,</span>
                </p>
              </div>
              <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0" data-name="Container" data-node-id="1:93">
                ...
                <div className="figma-font-halant-ptbr col-1 flex flex-col justify-center ml-0 mt-[11.4px] not-italic relative row-1 text-[#393737] text-[0px] text-center tracking-[-3.5px] whitespace-nowrap" data-node-id="1:111">
                  <p className="text-[70px]">
                    <span className="figma-font-halant-ptbr not-italic text-[#888787] tracking-[-3.5px] leading-[90px]">mas</span>
                    <span className="leading-[90px]">{` `}</span>
                    <span className="figma-font-georgia not-italic tracking-[-3.5px] leading-[90px]">produto</span>
                  </p>
                </div>
                <div className="figma-font-georgia col-1 flex flex-col justify-center ml-[524.75px] mt-[11.4px] not-italic relative row-1 text-[#393737] text-[70px] text-center tracking-[-3.5px] whitespace-nowrap" data-node-id="1:112">
                  <p className="leading-[90px]">nasce no Figma</p>
                </div>
              </div>
            </div>
            <div className="figma-font-geist flex flex-col font-normal justify-center opacity-50 relative shrink-0 text-[20px] text-black text-center w-[792px]" data-node-id="1:113">
              <p className="leading-[32px]">Oi, eu sou o Victor. Aqui eu vou te contar sobre o que andei fazendo nestes quase 10 anos entre milhares de produtos e serviços que são usados por milhões de pessoas.</p>
            </div>
          </div>
...
await agent.run();`}
        ...
        <div className="content-stretch flex items-start justify-center relative shrink-0" data-node-id="1:573">
          <div className="content-stretch flex flex-col gap-[42px] items-start relative shrink-0 w-[588px]" data-node-id="1:574">
            ...
            <div className="content-stretch flex flex-col gap-[20px] items-start leading-[0] relative shrink-0 w-[486px]" data-node-id="1:579">
              ...
              <div className="figma-font-geist flex flex-col font-normal justify-center opacity-60 relative shrink-0 text-[16px] text-black w-[486px]" data-node-id="1:583">
              ...
              <div className="figma-font-geist-mono flex flex-col font-medium justify-center relative shrink-0 text-[#f54e2d] text-[15px] w-[383px]" data-node-id="1:584">
            ...
            <div className="content-stretch flex flex-col gap-[20px] items-start leading-[0] relative shrink-0 w-[460px]" data-name="Text Block" data-node-id="1:599">
              <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[460px]" data-name="Description Block" data-node-id="1:600">
                ...
                <div className="figma-font-geist flex flex-col font-normal justify-center opacity-60 relative shrink-0 text-[16px] text-black w-full" data-node-id="1:602">
                  <p className="whitespace-pre-wrap leading-[26px]">{`O Coolhunting é um SaaS privado que revolucionou todo o processo manual de pesquisa de mercado e concorrência com  visão holística do comportamento dos consumidores, e isso é só a ponta. A plataforma cria dossiês estruturados com dados reais do ERP e se alimenta constantemente através da inteligência de dados captadas em múltiplas fontes. `}</p>
                </div>
              </div>
          ...
          <div className="content-stretch flex gap-[24px] items-end relative shrink-0 w-full" data-name="Additional Content" data-node-id="1:604">
              ...
              <div className="content-stretch flex flex-col gap-[16px] items-center relative shrink-0 w-full" data-name="Helper Container" data-node-id="1:606">
                <div className="content-stretch flex items-start px-[16px] relative shrink-0 w-full" data-name="Indicator Container" data-node-id="1:607">
                  <div className="content-stretch flex gap-[5px] items-center opacity-60 relative shrink-0" data-name="Indicators" data-node-id="1:608">
                    <div className="bg-[#dbdbdb] rounded-[100px] shrink-0 size-[10px]" data-name="Container" data-node-id="1:609" />
                    <div className="bg-[#dbdbdb] rounded-[16777200px] shrink-0 size-[10px]" data-name="Container" data-node-id="1:610" />
                    <div className="bg-[#dbdbdb] rounded-[16777200px] shrink-0 size-[10px]" data-name="Container" data-node-id="1:611" />
                  </div>
                </div>
                <div className="content-stretch flex flex-col items-start px-[20px] relative shrink-0 w-full" data-name="Helper Text Container" data-node-id="1:612">
                  <div className="bg-[#f6f6f6] content-stretch flex flex-col h-[132px] items-start justify-between px-[18px] py-[16px] relative rounded-[18px] shrink-0 w-full" data-name="Helper Text Block" data-node-id="1:613">
                    <div className="figma-font-geist flex flex-col font-medium justify-center leading-[0] relative shrink-0 text-[#979797] text-[14px] tracking-[0.3px] whitespace-nowrap" data-node-id="1:614">
                      <p className="leading-[normal]">Como posso ajudar você hoje?</p>
                    </div>
                    <div className="content-stretch flex items-end justify-between relative shrink-0 w-full" data-name="Helper Options" data-node-id="1:615">
                      <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Options Container" data-node-id="1:616">
                        <div className="backdrop-blur-[5px] bg-[rgba(96,96,96,0.7)] content-stretch flex h-[30px] items-center justify-center px-[16px] py-[18px] relative rounded-[100px] shrink-0" data-name="Option" data-node-id="1:617">
                          <div className="figma-font-geist flex flex-col font-normal justify-center leading-[0] relative shrink-0 text-[13px] text-white whitespace-nowrap" data-node-id="1:618">
                            <p className="leading-[normal]">Fábrica</p>
                          </div>
                          <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_2px_2px_4px_0px_rgba(255,255,255,0.1),inset_2px_2px_8px_0px_rgba(255,255,255,0.09)]" />
                        </div>
                        <div className="backdrop-blur-[5px] bg-[rgba(96,96,96,0.7)] content-stretch flex h-[30px] items-center justify-center px-[16px] py-[18px] relative rounded-[100px] shrink-0" data-name="Option" data-node-id="1:619">
                          <div className="figma-font-geist flex flex-col font-normal justify-center leading-[0] relative shrink-0 text-[13px] text-white whitespace-nowrap" data-node-id="1:620">
                            <p className="leading-[normal]">Automações</p>
                          </div>
                          <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_2px_2px_4px_0px_rgba(255,255,255,0.1),inset_2px_2px_8px_0px_rgba(255,255,255,0.09)]" />
                        </div>
                        <div className="backdrop-blur-[5px] bg-[rgba(96,96,96,0.7)] content-stretch flex h-[30px] items-center justify-center px-[16px] py-[18px] relative rounded-[100px] shrink-0" data-name="Option" data-node-id="1:621">
                          <div className="figma-font-geist flex flex-col font-normal justify-center leading-[0] relative shrink-0 text-[13px] text-white whitespace-nowrap" data-node-id="1:622">
                            <p className="leading-[normal]">Alertas</p>
                          </div>
                          <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_2px_2px_4px_0px_rgba(255,255,255,0.1),inset_2px_2px_8px_0px_rgba(255,255,255,0.09)]" />
                        </div>
                      </div>
                      <div className="backdrop-blur-[7.58px] bg-[#1d8591] content-stretch flex items-center justify-center px-[16px] py-[18px] relative rounded-[100px] shrink-0 size-[36px]" data-name="Sparkle Container" data-node-id="1:623">
                        ...
                        <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_2px_2px_7px_0px_rgba(255,255,255,0.36)]" />
                      </div>
                    </div>
                    <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_3px_3px_5px_0px_rgba(0,0,0,0.04)]" />
                  </div>
                </div>
              </div>
                  ...
                  <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Thermometer Header" data-node-id="1:630">
                    <div className="content-stretch flex items-center relative shrink-0" data-name="Thermometer Title Container" data-node-id="1:631">
                      <div className="figma-font-geist flex flex-col font-semibold justify-center leading-[0] relative shrink-0 text-[#393737] text-[14px] whitespace-nowrap" data-node-id="1:638">
                        <p className="leading-[normal]">Termômetro</p>
                      </div>
                    </div>
                    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Clip path group" data-node-id="1:639">
            ...
            <div className="h-[348px] overflow-clip relative shrink-0 w-[282px]" data-name="Graph Container" data-node-id="3:731">
              ...
              <div className="absolute h-[348px] left-0 rounded-[30px] top-0 w-[282px]" data-name="Icon background" data-node-id="1:667">
                <div className="absolute backdrop-blur-[12.5px] bg-gradient-to-b from-[rgba(38,38,38,0.6)] inset-0 rounded-[30px] to-[rgba(10,10,10,0.7)]" data-name="Base blur 20" data-node-id="1:668" />
                <div className="absolute blur-[1px] border-3 border-solid border-white inset-[0_0_1px_1px] opacity-50 rounded-[30px]" data-name="Highlights" data-node-id="1:672" />
              </div>
              <div className="absolute content-stretch flex flex-col gap-[20px] items-center left-0 top-[20px] w-[282px]" data-name="Graph Content" data-node-id="1:673">
                <div className="content-stretch flex items-center justify-between px-[20px] relative rounded-[20px] shrink-0 w-full" data-name="Graph Header" data-node-id="1:674">
                  <div className="figma-font-geist flex flex-col font-medium justify-center leading-[0] relative shrink-0 text-[14px] text-white whitespace-nowrap" data-node-id="1:675">
                    <p className="leading-[normal]">Avaliações</p>
                  </div>
                ...
                <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Graph Chart Area" data-node-id="1:679">
                ...
                <div className="figma-font-geist content-stretch flex font-medium gap-[16px] items-center justify-center leading-[0] relative rounded-[20px] shrink-0 text-[13px] text-white w-full whitespace-nowrap" data-name="Graph Months" data-node-id="1:696">
                  <div className="flex flex-col justify-center opacity-50 relative shrink-0" data-node-id="1:697">
                    <p className="leading-[normal]">Jan</p>
                  </div>
                  <div className="flex flex-col justify-center opacity-50 relative shrink-0" data-node-id="1:698">
                    <p className="leading-[normal]">Fev</p>
                  </div>
                  <div className="flex flex-col justify-center opacity-50 relative shrink-0" data-node-id="1:699">
                    <p className="leading-[normal]">Mar</p>
                  </div>
                  <div className="flex flex-col justify-center opacity-50 relative shrink-0" data-node-id="1:700">
                    <p className="leading-[normal]">Abr</p>
                  </div>
                  <div className="flex flex-col justify-center opacity-50 relative shrink-0" data-node-id="1:701">
                    <p className="leading-[normal]">Jun</p>
                  </div>
                  <div className="flex flex-col justify-center opacity-50 relative shrink-0" data-node-id="1:702">
        ...
        <div className="h-[455.5px] relative shrink-0 w-[1200px]" data-name="Container" data-node-id="3:733">
          <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[452px] top-[121px] w-[680px]" data-name="Review Container" data-node-id="1:727">
            <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Header Section" data-node-id="1:728">
              ...
              <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="Indicators Section" data-node-id="1:730">
                <div className="flex items-center justify-center relative shrink-0">
                  <div className="-scale-y-100 flex-none rotate-180">
                    <div className="relative size-[32px]" data-node-id="1:731">
                      <img alt="" className="absolute block max-w-none size-full" src={imgFrame1410137285} />
                    </div>
                  </div>
                </div>
                <div className="figma-font-geist flex flex-col font-normal justify-center leading-[0] opacity-50 relative shrink-0 text-[14px] text-black whitespace-nowrap" data-node-id="1:733">
                  <p className="leading-[normal]">1 de 4</p>
                </div>
                <div className="relative shrink-0 size-[32px]" data-name="Next Indicator Container" data-node-id="1:734">
                  <img alt="" className="absolute block max-w-none size-full" src={imgNextIndicatorContainer} />
                </div>
              </div>
            </div>
              ...
              <div className="absolute h-[406px] left-px top-[47px] w-[384px]" data-name="Avatar-background" data-node-id="1:925">
                <div className="absolute contents left-0 top-0" data-name="Avatar-background" data-node-id="1:926">
                  ...
                  <div className="absolute left-[24px] top-[42px] w-[336px]" data-name="avatar" data-node-id="1:941">
                    <img alt="" className="max-w-none w-full" src={imgAvatar} />
                  </div>
                </div>
              </div>
          ...
          <div className="content-stretch flex gap-[102px] items-center relative shrink-0 w-full" data-name="Main Container" data-node-id="1:950">
            <div className="content-stretch flex flex-col gap-[37px] items-start leading-[0] relative shrink-0 w-[510px]" data-name="Left Section" data-node-id="1:951">
              <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full" data-name="Text Container" data-node-id="1:952">
                ...
                <div className="figma-font-geist-mono flex flex-col font-medium justify-center relative shrink-0 text-[#f54e2d] text-[15px] w-full" data-node-id="1:954">
                  <p className="leading-[21px]">Mas, os layouts eram responsivos em apenas dois breakpoints mal enquadrados, web e app pareciam dois produtos de empresas diferentes, e o esforço cognitivo do aluno era desproporcional ao conteúdo consumido. Então, como redesenhar uma plataforma inteira sem prejudicar os alunos que já viviam dentro dela?</p>
                </div>
                <div className="figma-font-geist flex flex-col font-normal justify-center opacity-60 relative shrink-0 text-[16px] text-black w-full" data-node-id="1:955">
                  <p className="leading-[26px]">O projeto começou pelos dados, montamos uma dashboard de data science com métricas de comportamento real, aulas mais assistidas, cursos mais concluídos, taxas de churn, padrões de engajamento. Para fechar, rodamos uma pesquisa qualitativa com cinco usuários divididos por maturidade, de novatos a avançados, buscando insights que os dados sozinhos não mostravam.</p>
                </div>
                <div className="figma-font-geist flex flex-col font-normal justify-center opacity-60 relative shrink-0 text-[16px] text-black w-full" data-node-id="1:956">
                  <p className="leading-[26px]">Com o mapa em mãos, redesenhei a plataforma inteira do zero, mobile first, garantindo que a experiência fosse coerente em qualquer dispositivo. Construí um Design System completo para a plataforma, estruturado em atomic design, do átomo ao organismo, componentizado, com variantes e interação.</p>
                </div>
                <div className="figma-font-geist flex flex-col font-normal justify-center opacity-60 relative shrink-0 text-[16px] text-black w-full" data-node-id="1:957">
                  <p className="leading-[26px]">O resultado foi uma experiência que acompanhou o peso do conteúdo. O aluno podia transitar entre dispositivos sem sentir que mudou de produto, e o time d’O Novo Mercado ganhou uma base de design que sustenta evoluções contínuas sem retrabalho.</p>
                </div>
              </div>
        ...
        <div className="content-stretch flex flex-col gap-[843px] h-[1274px] items-center pb-[35px] pt-[82px] px-[36px] relative shrink-0 w-[1200px]" data-name="Background" data-node-id="1:988">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgBackground} />
          <div className="content-stretch flex flex-col gap-[12px] items-center leading-[0] relative shrink-0 text-center w-[792px]" data-name="Container" data-node-id="1:989">
            <div className="figma-font-georgia flex flex-col justify-center not-italic relative shrink-0 text-[48px] text-white tracking-[-0.96px] whitespace-nowrap" data-node-id="1:990">
              <p className="leading-[normal]">O que eu andei construindo com IA</p>
            </div>
            <div className="figma-font-geist bg-clip-text bg-gradient-to-r flex flex-col font-light from-[#cfcfcf] justify-center mix-blend-color-dodge relative shrink-0 text-[18px] text-[transparent] to-[#cfcfcf] tracking-[0.5px] via-1/2 via-[#dce0e6] w-[792px]" data-node-id="1:991" style={{ fontFeatureSettings: "'ordn'" }}>
          ...
          <div className="content-stretch flex gap-[12px] items-center justify-center pb-[11px] pt-[10px] px-[12px] relative shrink-0" data-name="Dock" data-node-id="1:992">
            <div className="absolute bg-[rgba(255,255,255,0.5)] inset-0 mix-blend-overlay rounded-[20px]" data-name="Dock Background" data-node-id="1:993" style={{ backdropFilter: 'blur(5px)', WebkitBackdropFilter: 'blur(5px)', clipPath: 'inset(0.3px round 19.7px)' }} />
            <div className="absolute border border-solid border-white inset-0 mix-blend-overlay pointer-events-none rounded-[20px]" />
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:994">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:995">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-1.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:996">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-2.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:997">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-3.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:998">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-4.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:999">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-5.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:1000">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-6.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:1001">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-7.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon Container" data-node-id="1:1002">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon Container.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:1007">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-8.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:1008">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-9.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:1009">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-10.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:1010">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-11.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:1011">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-12.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:1012">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-13.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:1013">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-14.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:1014">
              <img alt="" className="block size-full" src="/visual-ir-assets/dock/Icon-15.svg" />
            </div>
            <div className="relative shrink-0 size-[50px]" data-name="Icon" data-node-id="1:1015">
        ...
        <div className="content-stretch flex flex-col gap-[42px] items-center relative shrink-0 w-[1200px]" data-name="Container" data-node-id="1:1016">
          ...
          <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Container" data-node-id="1:1018">
                ...
                <div className="bg-white border border-[rgba(3,3,2,0.12)] border-solid content-stretch flex flex-col gap-[24px] h-full items-start leading-[0] overflow-clip pt-[24px] px-[24px] relative rounded-[20px] shadow-[0px_50px_40px_0px_rgba(0,0,0,0.01),0px_50px_40px_0px_rgba(0,0,0,0.02),0px_20px_40px_0px_rgba(0,0,0,0.05),0px_3px_10px_0px_rgba(0,0,0,0.08)] shrink-0 w-[690px]" data-name="Container" data-node-id="1:1020">
                  <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Container" data-node-id="1:1021">
                    <div className="content-stretch flex items-center justify-between relative shrink-0 text-[#393737] w-full whitespace-nowrap" data-name="Container" data-node-id="1:1022">
                      ...
                      <div className="figma-font-geist flex flex-col font-normal justify-center relative shrink-0 text-[14px] tracking-[0.14px]" data-node-id="1:1024">
                        <p className="leading-[normal]">iGreen Energy</p>
                      </div>
                    </div>
                    <div className="figma-font-geist flex flex-col font-normal justify-center opacity-50 relative shrink-0 text-[16px] text-black w-full" data-node-id="1:1025">
                      <p className="leading-[24px]">Fui o primeiro designer da iGreen. Para os clientes entreguei o Conexão Green e o app Club dividido em Energia e Telecom. Para o licenciado, projetei seu app de trabalho.</p>
                    </div>
                  </div>
                ...
                <div className="bg-white border border-[rgba(3,3,2,0.12)] border-solid content-stretch flex flex-col gap-[32px] h-full items-start overflow-clip pt-[24px] px-[24px] relative rounded-[20px] shadow-[0px_50px_40px_0px_rgba(0,0,0,0.01),0px_50px_40px_0px_rgba(0,0,0,0.02),0px_20px_40px_0px_rgba(0,0,0,0.05),0px_3px_10px_0px_rgba(0,0,0,0.08)] shrink-0 w-[486px]" data-name="Container" data-node-id="1:1029">
                  <div className="content-stretch flex flex-col gap-[8px] items-start leading-[0] relative shrink-0 w-full" data-name="Container" data-node-id="1:1030">
                    <div className="content-stretch flex items-center justify-between relative shrink-0 text-[#393737] w-full whitespace-nowrap" data-name="Container" data-node-id="1:1031">
                      ...
                      <div className="figma-font-geist flex flex-col font-normal justify-center relative shrink-0 text-[14px] tracking-[0.14px]" data-node-id="1:1033">
                        <p className="leading-[normal]">Algar Telecom</p>
                      </div>
                    </div>
                    <div className="figma-font-geist flex flex-col font-normal justify-center opacity-50 relative shrink-0 text-[16px] text-black w-full" data-node-id="1:1034">
                      <p className="leading-[24px]">Com papel focado em promover autosserviço nos canais digitais, atuei no app, e-commerce e pós login B2B e B2C.</p>
                    </div>
                  </div>
                  <div className="h-[266px] overflow-clip relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full" data-name="Container" data-node-id="1:1035">
            ...
            <div className="content-stretch flex gap-[24px] h-[399px] items-center relative shrink-0 w-full" data-name="Container" data-node-id="1:1043">
              <div className="flex flex-row items-center self-stretch">
                <div className="bg-white border border-[rgba(3,3,2,0.12)] border-solid content-stretch flex flex-col gap-[32px] h-full items-start overflow-clip pt-[24px] relative rounded-[20px] shadow-[0px_50px_40px_0px_rgba(0,0,0,0.01),0px_50px_40px_0px_rgba(0,0,0,0.02),0px_20px_40px_0px_rgba(0,0,0,0.05),0px_3px_10px_0px_rgba(0,0,0,0.08)] shrink-0 w-[486px]" data-name="Container" data-node-id="1:1044">
                  <div className="content-stretch flex flex-col gap-[8px] items-start leading-[0] px-[24px] relative shrink-0 w-full" data-name="Container" data-node-id="1:1045">
                    <div className="content-stretch flex items-center justify-between relative shrink-0 text-[#393737] w-full whitespace-nowrap" data-name="Container" data-node-id="1:1046">
                      ...
                      <div className="figma-font-geist flex flex-col font-normal justify-center relative shrink-0 text-[14px] tracking-[0.14px]" data-node-id="1:1048">
                        <p className="leading-[normal]">Prefeitura de Maceió</p>
                      </div>
                    </div>
                    <div className="figma-font-geist flex flex-col font-normal justify-center opacity-50 relative shrink-0 text-[16px] text-black w-full" data-node-id="1:1049">
                      <p className="leading-[24px]">App de turismo que dá as pessoas uma experiência guiada listando as praias, transporte, gastronomia e muito mais.</p>
                    </div>
                  </div>
                ...
                <div className="bg-white border border-[rgba(3,3,2,0.12)] border-solid content-stretch flex flex-col gap-[32px] h-full items-start leading-[0] overflow-clip pt-[24px] px-[24px] relative rounded-[20px] shadow-[0px_50px_40px_0px_rgba(0,0,0,0.01),0px_50px_40px_0px_rgba(0,0,0,0.02),0px_20px_40px_0px_rgba(0,0,0,0.05),0px_3px_10px_0px_rgba(0,0,0,0.08)] shrink-0 w-[690px]" data-name="Container" data-node-id="1:1053">
                  <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Container" data-node-id="1:1054">
                    <div className="content-stretch flex items-center justify-between relative shrink-0 text-[#393737] w-full whitespace-nowrap" data-name="Container" data-node-id="1:1055">
                      ...
                      <div className="figma-font-geist flex flex-col font-normal justify-center relative shrink-0 text-[14px] tracking-[0.14px]" data-node-id="1:1057">
                        <p className="leading-[normal]">Sankhya</p>
                      </div>
                    </div>
        ...
        <div className="content-stretch flex flex-col gap-[42px] items-center relative shrink-0 w-[1200px]" data-name="Container" data-node-id="1:1062">
          <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-[997px]" data-name="Header" data-node-id="1:1063">
            ...
            <div className="figma-font-geist flex flex-col font-normal justify-center leading-[0] opacity-60 relative shrink-0 text-[20px] text-black text-center w-[791px]" data-node-id="1:1065">
          ...
          <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full" data-name="Content" data-node-id="1:1073">
            <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[384px]" data-name="Image Container" data-node-id="1:1074">
              ...
              <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Icons Row" data-node-id="1:1076">
                <div className="relative shrink-0 size-[82px]" data-name="icon-5 4" data-node-id="1:1077">
                  <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIcon54} />
                </div>
                <div className="relative shrink-0 size-[82px]" data-name="icon-5 3" data-node-id="1:1078">
                  <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIcon53} />
                </div>
                <div className="relative shrink-0 size-[82px]" data-name="icon-5 5" data-node-id="1:1079">
                  <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIcon55} />
                </div>
                <div className="relative shrink-0 size-[82px]" data-name="icon-5 1" data-node-id="1:1080">
                  <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIcon51} />
                </div>
              </div>
            </div>
            <div className="overflow-clip relative shrink-0 size-[384px]" data-name="Main Image Container" data-node-id="1:1081">
            ...
            <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-[384px]" data-name="Image Container" data-node-id="1:1085">
              ...
              <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Icons Row" data-node-id="1:1090">
                <div className="relative shrink-0 size-[82px]" data-name="icon-5 4" data-node-id="1:1091">
                  <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIcon56} />
                </div>
                <div className="relative shrink-0 size-[82px]" data-name="icon-5 3" data-node-id="1:1092">
                  <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIcon57} />
                </div>
                <div className="relative shrink-0 size-[82px]" data-name="icon-5 5" data-node-id="1:1093">
                  <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIcon58} />
                </div>
                <div className="relative shrink-0 size-[82px]" data-name="icon-5 1" data-node-id="1:1094">
