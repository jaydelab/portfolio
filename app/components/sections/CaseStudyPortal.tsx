...
export default function CaseStudyPortal({ id, className = "" }: CaseStudyPortalProps = {}) {
  return (
    <div id={id} className={`content-stretch flex max-md:flex-col gap-[24px] items-start justify-center relative shrink-0 ${className}`.trim()} data-name="Image" data-node-id="1:719">
            <div className="h-[477.018px] relative shrink-0 w-[792px] max-md:w-full" data-name="003 2 1" data-node-id="1:720">
              <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img00321} />
            </div>
            <div className="content-stretch flex flex-col gap-[20px] items-start leading-[0] pt-[48px] relative shrink-0 w-[384px] max-md:w-full" data-name="Container" data-node-id="1:721">
              <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Text Container" data-node-id="1:722">
                <div className="figma-font-georgia flex flex-col justify-center not-italic relative shrink-0 text-[#393737] text-[32px] max-lg:text-[clamp(22px,3.5vw,32px)] w-full" data-node-id="1:723">
