...
export default function HighlightsSection({ id, className = "" }: HighlightsSectionProps = {}) {
  return (
    <div id={id} className={`content-stretch flex flex-col gap-[843px] max-md:gap-[clamp(120px,30vw,843px)] h-[1274px] items-center pb-[35px] pt-[82px] px-[36px] relative shrink-0 w-[1200px] max-lg:w-full max-md:h-auto ${className}`.trim()} data-name="Background" data-node-id="1:988">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgBackground} />
            <div className="content-stretch flex flex-col gap-[12px] items-center leading-[0] relative shrink-0 text-center w-[792px] max-md:w-full" data-name="Container" data-node-id="1:989">
              <div className="figma-font-georgia flex flex-col justify-center not-italic relative shrink-0 text-[48px] max-lg:text-[clamp(28px,4.8vw,48px)] text-white tracking-[-0.96px] whitespace-nowrap" data-node-id="1:990">
                <p className="leading-[normal]">O que eu andei construindo com IA</p>
              </div>
              <div className="figma-font-geist bg-clip-text bg-gradient-to-r flex flex-col font-light from-[#cfcfcf] justify-center mix-blend-color-dodge relative shrink-0 text-[18px] text-[transparent] to-[#cfcfcf] tracking-[0.5px] via-1/2 via-[#dce0e6] w-[792px] max-md:w-full" data-node-id="1:991" style={{ fontFeatureSettings: "'ordn'" }}>
            ...
            <div className="content-stretch flex gap-[12px] items-center justify-center pb-[11px] pt-[10px] px-[12px] relative shrink-0 max-md:overflow-x-auto max-md:flex-nowrap scrollbar-hide" data-name="Dock" data-node-id="1:992">
