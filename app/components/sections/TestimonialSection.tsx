...
export default function TestimonialSection({ id, className = "" }: TestimonialSectionProps = {}) {
  return (
    <div id={id} className={`h-[455.5px] min-[768px]:h-auto min-[769px]:h-[455.5px] relative shrink-0 w-[1200px] max-lg:w-full max-md:h-auto ${className}`.trim()} data-name="Container" data-node-id="3:733">
            <div className="max-[768.99px]:hidden absolute content-stretch flex flex-col gap-[20px] items-start left-[452px] top-[121px] w-[680px]" data-name="Review Container" data-node-id="1:727">
              ...
              <div className="figma-font-geist flex flex-col font-normal h-[143px] justify-center leading-[0] relative shrink-0 text-[#393737] text-[18px] max-lg:text-[clamp(15px,2vw,18px)] w-full" data-node-id="1:736">
      ...
      <div className="hidden min-[768px]:flex min-[769px]:hidden flex-col gap-[16px] items-start mx-[-24px] px-[42px] w-[calc(100%+48px)]" data-name="Testimonial-tablet" data-node-id="69:925">
        ...
        <div className="content-stretch flex flex-col gap-[10px] h-[326px] items-end justify-end px-[24px] py-[24px] relative shrink-0 w-full" data-node-id="69:651">
          ...
          <div className="content-stretch flex flex-col gap-[30px] items-start relative shrink-0 w-[353px]" data-node-id="68:616">
            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-node-id="68:617">
              ...
              <div className="figma-font-geist font-normal justify-center leading-[0] relative shrink-0 text-[#393737] text-[14px] tracking-[-0.2px] w-full" data-node-id="68:619">
                <p className="leading-[21px]">Victor tem demonstrado ser uma pessoa muito solícita, sempre aberto a ouvir e colaborar da melhor forma possível. Ele apresenta boa habilidade de comunicação e, além disso, mantém excelente coerência em seu raciocínio. É extremamente educado, preocupado e atencioso. Sem dúvidas, é alguém com quem eu gostaria de trabalhar por muito tempo.</p>
              </div>
            </div>
            <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-node-id="68:623">
              <div className="figma-font-geist font-normal opacity-50 text-[12px] text-black w-full" data-node-id="68:624">
                <p className="leading-[20px]">Mayra Santos, Gerente de inovação e Desenvolvimento de Software</p>
              </div>
              <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-node-id="68:625">
                ...
                <div className="h-[15px] relative shrink-0 w-[39px]" data-node-id="68:627">
                  <img alt="" className="absolute block max-w-none size-full" src={imgBadgeWap} />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="hidden max-md:flex flex-col gap-[16px] items-start w-full mt-[62px]" data-name="Testimonial-mobile" data-node-id="67:2213">
        <div className="figma-font-georgia h-[68px] not-italic text-[24px] text-[#393737] tracking-[-0.48px] w-full" data-node-id="67:2214">
                ...
                <div className="-translate-x-1/2 -translate-y-1/2 absolute left-[calc(50%+0.5px)] size-[173px] top-[calc(50%+10px)]" data-node-id="67:2412">
                    ...
                    <div className="flex-none rotate-180">
                      <div className="opacity-20 relative size-[138.875px]" data-node-id="67:2415">
                        <div className="absolute inset-[-21.6%]">
                          <img alt="" className="block max-w-none size-full" src={imgEllipse54} />
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="-scale-y-100 flex-none rotate-180">
                      <div className="opacity-30 relative size-[114.472px]" data-node-id="67:2416">
                        <div className="absolute inset-[-26.21%]">
                          <img alt="" className="block max-w-none size-full" src={imgEllipse55} />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="absolute flex items-center justify-center left-[10px] size-[114.472px] top-0">
                    <div className="flex-none rotate-180">
                      <div className="opacity-30 relative size-[114.472px]" data-node-id="67:2417">
                        <div className="absolute inset-[-26.21%]">
                          <img alt="" className="block max-w-none size-full" src={imgEllipse56} />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute left-1/2 top-[calc(50%+3px)] -translate-x-1/2 -translate-y-1/2 rounded-[14px] size-[192.6px]" data-name="avatar" data-node-id="67:2418">
                    <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[14px]">
                      <img alt="" className="absolute left-[-8%] max-w-none size-[116%] top-[-16.09%]" src={imgAvatar} />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-[30px] items-start relative shrink-0 w-full" data-name="Review Container" data-node-id="67:2421">
            ...
            <div className="flex flex-col gap-[16px] items-start w-full" data-node-id="67:2428">
              ...
              <div className="flex items-center justify-between w-full" data-node-id="67:2430">
                ...
                <div className="h-[15px] relative shrink-0 w-[39px]" data-name="Badge" data-node-id="67:2432">
                  <img alt="" className="absolute block max-w-none size-full" src={imgBadgeWap} />
                </div>
              </div>
            </div>
