...
const imgCaseWapPhone = assetUrl("/visual-ir-assets/case-wap-phone.webp");
const imgCaseNovoMercado = assetUrl("/visual-ir-assets/case-novomercado.webp");
const imgCaseArrow = assetUrl("/visual-ir-assets/case-arrow.svg");
const imgLogoWap = assetUrl("/visual-ir-assets/logo-wap.svg");
const imgCaseIntroTabletNovoMercado = assetUrl("/visual-ir-assets/case-intro-tablet-nm.webp");
const imgCaseIntroTabletNovoMercadoLogo = assetUrl("/visual-ir-assets/case-intro-tablet-nm-logo.svg");
const imgCaseIntroTabletWapLogo = assetUrl("/visual-ir-assets/case-intro-wap-logo-tablet.svg");
  ...
  return (
    <div id={id || "cases"} className={`content-stretch flex flex-col gap-[52px] max-lg:gap-[24px] items-center justify-center relative shrink-0 w-full max-w-[1200px] ${className}`.trim()} data-name="Container" data-node-id="1:510">
      ...
      <div className="hidden min-[768px]:flex min-[1024px]:hidden flex-col gap-[16px] items-start w-full max-w-[684px] mx-auto" data-name="CaseStudies-tablet" data-node-id="68:97">
        <div className="figma-font-georgia not-italic text-[32px] text-[#393737] tracking-[-0.64px] w-[272px]" data-node-id="68:98">
          <p className="leading-[44px]">
            <HeroTitleTextReveal text="Últimos trabalhos" delay={0} noWrap={false} />
          </p>
        </div>
      ...
      <div className="hidden max-md:flex flex-col gap-[16px] items-start w-full max-w-[480px] mx-auto mt-[62px]" data-name="CaseStudies-mobile">
        ...
        {/* Card 2 - WAP */}
        <div className="bg-white border border-[rgba(3,3,2,0.12)] border-solid flex flex-col gap-[32px] items-start overflow-clip pt-[16px] rounded-[20px] shadow-[0px_50px_40px_0px_rgba(0,0,0,0.01),0px_50px_40px_0px_rgba(0,0,0,0.02),0px_20px_40px_0px_rgba(0,0,0,0.05),0px_3px_10px_0px_rgba(0,0,0,0.08)] w-full" data-name="case01" data-node-id="67:2173">
          <div className="flex flex-col gap-[12px] items-start px-[20px] w-full">
            <div className="flex gap-[8px] items-start w-full">
              <div className="flex flex-[1_0_0] flex-col figma-font-georgia not-italic text-[18px] text-[#393737] tracking-[-0.36px] min-h-px min-w-px">
                <p className="leading-[26px]">Um novo negócio, uma barreira e uma reunião</p>
