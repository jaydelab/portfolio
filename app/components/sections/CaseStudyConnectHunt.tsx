...
export default function CaseStudyConnectHunt({ id, className = "" }: CaseStudyConnectHuntProps = {}) {
  return (
    <div id={id} className={`h-[580px] max-md:h-auto max-md:min-h-[300px] overflow-clip relative rounded-[30px] shrink-0 w-full max-w-[1200px] ${className}`.trim()} data-name="Logo" data-node-id="1:703">
      <h3 className="sr-only">ConnectHunt</h3>
